...
bool do_filter;
bool do_filter2;
double time_seeds, time_locations, time_filter, time_swa, total_shift_time;
...
void filter_and_finalize_reads(const std::string &reads, std::vector<uint32_t> & locations);
