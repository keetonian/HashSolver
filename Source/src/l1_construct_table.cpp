...
#include "genome.hpp"
#include "l1_construct_table.hpp"
#include "l1_commandline.hpp"
...
int main(int argc, char** argv){
  ...
  create_name(hashtable.get_name());
...
void create_name(string hashtable_name){
  // Set up file name
  stringstream namestream;
  namestream << directory << "/L1" << hashtable_name << "-";
